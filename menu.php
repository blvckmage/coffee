...
<head>
    ...
    <title>Меню - Tanqurai bread & coffee</title>
            ...
            <div class="header-content">
                ...
                <nav class="nav">
                    <ul class="nav-list">
                        ...
                        <li class="nav-item">
                            <a href="menu.php" class="nav-link active">Меню</a>
                        </li>
                        <li class="nav-item dropdown">
                ...
                <nav class="mobile-nav">
                    <ul class="mobile-nav-list">
                        ...
                        <li><a href="menu.php" class="mobile-nav-link active">Меню</a></li>
            ...
            <div class="container">
                <div class="hero-content">
                    <div class="hero-text" data-aos="fade-up">
                        <h1 data-aos="fade-up">Наше меню</h1>
                        <p data-aos="fade-up" data-aos-delay="200">Вкусные напитки и десерты, приготовленные с любовью из лучших ингредиентов</p>
                    </div>
                    <div class="hero-stats" data-aos="fade-up" data-aos-delay="400">
                        <div class="stat-item">
                            <span class="stat-number">20+</span>
                            <span class="stat-label">Позиций в меню</span>
                        </div>
                        <div class="stat-item">
                            <span class="stat-number">100%</span>
                            <span class="stat-label">Свежие ингредиенты</span>
                        </div>
                        <div class="stat-item">
                ...
                if ($menu) {
                    foreach ($menu as $category => $items) {
                        ...
                        <div class="menu-category" data-aos="fade-up">
                            <h2><?php echo htmlspecialchars(capitalizeCategory($category)); ?></h2>
                    ...
                    // Fallback menu
                    $fallbackMenu = [
                        'espresso-bar' => [['name' => 'Эспрессо', 'price' => 250, 'image' => 'images/espresso.jpg'], ['name' => 'Капучино', 'price' => 400, 'image' => 'images/cappuccino.jpg']],
                        'desserts' => [['name' => 'Тирамису', 'price' => 600, 'image' => 'images/coffee-texture.jpg'], ['name' => 'Чизкейк', 'price' => 500, 'image' => 'images/americano.jpg']]
                    ];
